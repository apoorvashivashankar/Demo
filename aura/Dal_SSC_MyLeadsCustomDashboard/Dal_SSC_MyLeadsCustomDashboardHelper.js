 ...
 */
({
     getLeadData:function(cmp,event,helper){
         //   debugger;
    ...
    */ 
                  var action = cmp.get("c.getreportForLeadConversionRate");
                  action.setParams({
                      LeadConversionRange : cmp.get("v.leadConversion"),
                      LeadStatusRange  :cmp.get("v.leadStatus"),
                      OpenLeadRange  :cmp.get("v.leadOpen")
                  })
    ...
    // --------------------------------- For Open Lead------------------------------------------------------------------
                           ...
                           cmp.set("v.leadsCount",response.getReturnValue().OpenLead);
                           console.log("LeadCount--->",cmp.get("v.leadsCount"));
    // ----------------------------------Setting Drop Down Value------------------------------------------------
                            cmp.set("v.leadConversion",response.getReturnValue().ConversionDropDownValue);
                            cmp.set("v.leadStatus",response.getReturnValue().StatusDropDownValue);
                            cmp.set("v.leadOpen",response.getReturnValue().OpenDropDownValue);
    // --------------------------------- For Donut Chart------------------------------------------------------------------
    ...
    */
    ...
    getDonutChartData : function(cmp,event,helper){
      //  debugger;
        var action = cmp.get("c.getReportForLeadConversion");
        action.setParams({ LeadConversionRange : cmp.get("v.leadConversion") });
        action.setCallback(this, function(response) {
            var state = response.getState();
            if (state === "SUCCESS") {
    ...
    getOpenLeadData : function(cmp,event,helper){
            var action = cmp.get("c.getReportForLeadOpen");
            action.setParams({ OpenLeadRange  :cmp.get("v.leadOpen") });
            action.setCallback(this, function(response) {
                var state = response.getState();
                if (state === "SUCCESS") {
            // ----------------------------------Setting Drop Down Value------------------------------------------------
    ...
    getPieChartData : function(cmp,event,helper){
              var action = cmp.get("c.getReportForLeadStatus");
              action.setParams({ LeadStatusRange  :cmp.get("v.leadStatus") });
              action.setCallback(this, function(response) {
                  var state = response.getState();
                  if (state === "SUCCESS") {
              // ----------------------------------Setting Drop Down Value------------------------------------------------
